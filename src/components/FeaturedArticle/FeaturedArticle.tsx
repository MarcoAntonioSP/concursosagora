...
export default function FeaturedArticle({ author, createdAt, subtitle, title, urlImage, slug }: CardNoticiasProps) {
  const date = new Date(createdAt); // Remover chaves aqui
