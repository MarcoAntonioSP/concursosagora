...
export function CardPost({ author, createdAt, subtitle, title, urlImage, slug, authorImage }: CardPostProps) {
  return (
    <div className="w-full sm:max-w-[352px] h-full flex flex-col items-center justify-between gap-2 sm:gap-4">
      <Link 
        href={`/aberto/${slug}`}
