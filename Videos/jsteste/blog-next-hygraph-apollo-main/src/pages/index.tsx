...
export default function Home({ posts, previstos, empregos }: AllPosts & AllPrevistos & AllEmpregos) {
  return (
    <>
      <Head>
        ...
        {posts ? (
          <>
            ...
            <div className='flex flex-col items-center sm:grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-8 mt-12'>
              ...
              <div>
                <h1 className='text-red-900 text-xl font-bold font-sans italic text-shadow-md mt-5 ml-5'>Próximos Concursos</h1>
                {/* Aqui chamamos o ListaPrevistos, mas limitamos a 3 itens */}
            <ListaPrevistos previstos={previstos.slice(0, 4)} />
              </div>
              <div>
                <h1 className='text-red-900 text-xl font-bold font-sans italic text-shadow-md mt-5 ml-5'>Oportunidades de Emprego</h1>
                {/* Aqui chamamos o ListaEmpregos, mas limitamos a 3 itens */}
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const { data: empregosData } = await client.query({ query: GET_ALL_EMPREGOS });
